  ...
  app.use(
    session({
      ...
      cookie: {
        ...
        // Scope to root domain so the session cookie is shared between
        // bareter.com and admin.bareter.com — the leading dot is required.
        domain: process.env.NODE_ENV === "production" ? ".bareter.com" : undefined,
      },
    })
  );
