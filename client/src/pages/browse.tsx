      ...
      {activeTab === "discover" ? (
        <div className="space-y-8">
          ...
          {(() => {
            ...
            const tilesPosts: TrendingTile[] = (trendingPosts ?? []).slice(0, 6).map((p) => ({
              kind: "post",
              id: p.id,
            ...
            const tilesListings: TrendingTile[] = (listings ?? [])
              .slice(0, 6)
              .map((l) => ({
                kind: "listing",
                id: l.id,
            ...
            // Interleave posts + listings, then keep up to 9 tiles for a 3-col grid
            const interleaved: TrendingTile[] = [];
            ...
            const tiles = interleaved.slice(0, 9);
            ...
            return (
              <section>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-bareter-navy dark:text-foreground" data-testid="text-trending-title">
                    Trending now
                  </h2>
                </div>
