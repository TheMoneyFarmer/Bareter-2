  ...
  if (!isVerified) {
    return (
      <div className="container px-4 py-12 mx-auto max-w-2xl text-center space-y-4">
        ...
        <a href="/profile" className="inline-flex items-center justify-center rounded-md text-sm font-medium bg-primary text-primary-foreground h-9 px-4 py-2 hover:bg-primary/90 transition-colors">Add WhatsApp</a>
      </div>
    );
  }
