  ...
  return (
    <div className="container px-4 py-12 mx-auto max-w-6xl">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">How Recipro Works</h1>
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-center mb-8">Why Trade on Recipro?</h2>
      ...
      <div className="text-center bg-primary/5 rounded-2xl p-8">
        ...
        <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
          Join hundreds of UAE businesses already trading on Recipro. Create your free account today.
        </p>
